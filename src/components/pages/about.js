...
//import imageTwo from "../../../static/assets/images/paris.jpg"; //FIXME: UPDATE IMG
        ...
        <div className="about-highlight">
          <div className="highlight-text-container">
            ...
            <div className="highlight-body">
              <p>
                {" "}
                They say a picture is worth a thousand words. Go ahead! Scroll
                away!{" "}
              </p>
            </div>
          </div>
            ...
            <div className="blocks-right-one" id="first-block">
              <div className="info-three">
                <div className="item" data-aos="fade-up">
                  <p>
                    {" "}
                    “My best advice for you is to take a coding class” was Randi
                    Zuckerberg advice to me when I asked her after explaining
                    the goals and dreams I have. Little did Randi know that two
                    years later I would working as a software developer and
                    fallen in love with programming.{" "}
                  </p>
                  <p>
                    {" "}
                    As a child I would sell “imported Peruvian soda” and “the
                    highest glitter bouncing balls in the world!” to any friend
                    that would hear my pitch. Business is something I have
                    always been passionate about since as long as I can remember
                    However, when I thought of future in business there was
                    something missing and I found it in tech. There is something
                    special when you see your first “hello world” or fix a bug
                    after hours and hours trying to solve it.
                  </p>
                  <p>
                    {" "}
                    I still have the goal as my elementary school self would say
                    “when I grow up I will own a big company” but as of now I am
                    loving learning new things everyday that comes in the path
                    to being a computer scientist and impassioned by mix of
                    business and tech.{" "}
                  </p>
                </div>
              </div>
            ...
            <div className="blocks-right-two" id="second-block">
              <div className="info-two">
                <div className="item" data-aos="fade-up">
                  ...
                  <p>
                    {" "}
                    Currently I am persuing my Computer Science Degree at
                    Brigham Young University. I'm a Latina dream board advocate
                    that loves JDM cars that should’ve been born in the ’50s.
                    I've always had identity crisis given that you’ll see me
                    whipping up a Peruvian dish like papa a la huancaina with my
                    Abuelita while jamming to Suavemente by Elvis Crespo then
                    later on listening to Bobby Darin, “Beyond the Sea”.{" "}
                  </p>
                  <p>
                    You can find me instantly smiling when I hear a high
                    horsepower supercharged import drives by, when my little
                    sisters draw little notes for me and seeing friends chase
                    dreams of their own. Fact: I speak English, Portuguese, and
                    Spanish! My best friends are my siblings and stack overflow.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="info-three">
                <div className="item" id="contact-block" data-aos="fade-up">
                  <div className="contact-info">
                    <p>
                      {" "}
                      Looking at building something awesome together? contact
                      me!
                    </p>
                    <p className="link">
                      {" "}
                      Email Me:{" "}
                      <a href="mailto:ksarmiento2000@gmail.com"> here </a>
                    </p>
                  </div>
                  <div className="contact-links">
                    <div className="contact-icon" data-aos="fade-up">
                      <a href="https://github.com/kiannalie" target="_blank">
                        <img src={github} />
                      </a>
                    </div>
                    ...
                    <div className="contact-icon" data-aos="fade-up">
                      <a
                        href="https://www.linkedin.com/in/kiannalie/"
                        target="_blank"
                      >
                        <img src={linkedin} />
                      </a>
                    ...
                    <div className="contact-icon" data-aos="fade-up">
                      <a
                        href="https://www.instagram.com/kiannalie/"
                        target="_blank"
                      >
                        <img src={instagram} />
                      </a>
