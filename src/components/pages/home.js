  ...
  return (
    <div className="home-page">
      <header>
        ...
        <div className="contact-me">
          <div className="about-me-block">
            ...
            <div className="home-about-me-block">
              ...
              <div className="home-about-me-photo" data-aos="fade-up">
                <a href="https://www.instagram.com/kiannalie/" target="_blank">
                  <img src={instagram} />
                </a>
              </div>

              <div className="home-about-me-photo" data-aos="fade-up">
                <a href="mailto:ksarmiento2000@gmail.com">
                  <img src={mail} />
                </a>
              </div>
        ...
        <div class="cs260-footer">
          <h1>CS260 project reqs: </h1>
          <a href="https://github.com/kiannalie/cs260-portfolio">
            {" "}
            Github link{" "}
          </a>
        </div>
